...
# Total:        114  160  28.0    172     199#
  ...
  ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer fkKRtN4mqhbcbigDHYOkBa8xt3b6VkTG' http://69054db6-3241-4f14-983f-dfa6ed7c8ffc.centralus.azurecontainer.io/score
